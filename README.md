...
Можно не запускать локально, т.к я уже задеплоил на удаленный хост. Весь функционал можно проверить по следующим эндпоинтам: 
- http://80.249.151.238:8000/ - главная страница
- http://80.249.151.238:8000/admin - админка (логин admin, пароль 123456789root)
- http://80.249.151.238:8000/api - апи 
